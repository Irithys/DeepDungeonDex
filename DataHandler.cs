...
namespace DeepDungeonDex
{
    public class DataHandler
    {
        ...
        private static readonly Dictionary<uint, MobData> mobs = new Dictionary<uint, MobData>()
            {
				// HoH floors 1-9
                { 7262, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true}, MobNotes="自动加重" } },
                { 7263, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true}, MobNotes="每10s给玩家物理易伤" } },
                { 7264, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true}, MobNotes="AoE 麻痹效果" } },
                { 7265, new MobData { Threat=MobData.ThreatLevel.Dangerous, Aggro=MobData.AggroType.Proximity, Vuln = new MobData.Vulnerabilities{CanStun = true}, MobNotes="三层流血效果" } },
                { 7266, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true}, MobNotes="睡眠紧接着AOE" } },
                { 7267, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = false}, MobNotes="AoE 施加流血效果" } },
                { 7268, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true}, MobNotes="凝视" } },
                ...
                { 7270, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true}, MobNotes="AoE 击退效果" } },
                { 7271, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true}, MobNotes="锥形 AoE 流血\nCircle AoE inflicts knockback" } },
                ...
                { 5413, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true, IsUndead = false}, MobNotes="\"Charybdis\" - 如果你不及时杀死他，它会吟唱一个大漩涡把你HP清空。" } },
                { 5414, new MobData { Threat=MobData.ThreatLevel.Dangerous, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true, IsUndead = false}, MobNotes="他的毒和劈斩会对DPS造成大量伤害，你不用生者秘药和魔陶器 强化防御的话会很困难。" } },
                { 5415, new MobData { Threat=MobData.ThreatLevel.Dangerous, Aggro=MobData.AggroType.Proximity, Vuln = new MobData.Vulnerabilities{CanStun = true, IsUndead = false}, MobNotes="Floors 141-150: \n大范围AOE尖啸会让你被迫走进房间，从而可能就会踩到陷阱或拉到怪。不过你可以眩晕和沉默它。\nFloors 191-200: \n他们会隔着房间对你释放点名AOE，通常一下一个。\n这个在附近时，绝对不要打深宫骑士，因为他的AOE瘟疫诅咒会覆盖死亡螺旋的内圈安全范围，让你避无可避。" } },
                ...
                { 5420, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Proximity, Vuln = new MobData.Vulnerabilities{CanStun = false, IsUndead = false}, MobNotes="释放凝视 \"邪恶之眼\"" } },
                { 5421, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{IsUndead = false}, MobNotes="它会使用物理攻击提升BUFF，然后使用一个无范围提示的AOE撕裂利爪，这个技能真的很疼。要么尾行他，要么绕路走。" } },
                { 5422, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Proximity, Vuln = new MobData.Vulnerabilities{CanStun = true, IsUndead = true}, MobNotes="高生命值和超大范围的“尖叫”" } },
                { 5423, new MobData { Threat=MobData.ThreatLevel.Dangerous, Aggro=MobData.AggroType.Sound, Vuln = new MobData.Vulnerabilities{CanStun = false, IsUndead = true}, MobNotes="会对地板造成超高伤害" } },
                { 5424, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, CanSlow = false, IsUndead = false}, MobNotes="被抓住会被止步，4小怪要打，梦魔不用打" } },
                // PotD 151-160
                { 5429, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true, CanBind = true, CanHeavy = true, CanSleep = true, IsUndead = false}, MobNotes="凝视会麻痹" } },
                { 5430, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="造成减益" } },
                { 5431, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="反射伤害，造成减速" } },
                ...
                { 5433, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true, CanBind = true, CanHeavy = true, CanSleep = false, IsUndead = false}, MobNotes="会吸血" } },
                ...
                { 5437, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Proximity, Vuln = new MobData.Vulnerabilities{CanStun = true, CanBind = true, CanHeavy = true, CanSleep = false, IsUndead = false}, MobNotes="凝视造成大量伤害并且失明" } },
                { 5438, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, CanSlow = false, IsUndead = false}, MobNotes="必须使用强化防御，踩进由悔恨殿制作出的流血区域，就是一跳5k的大伤害。除此之外，确定你不会被顶到爆炸球AOE中，否则BOSS紧接一刀你就死了。" } },
                // PotD 161-170
                ...
                { 5449, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, CanSlow = false, IsUndead = false}, MobNotes="在第一个沉重效果慢慢衰减时预留一个疾跑或打断，这是因为你需要用这个来逃过随之而来的生物电AOE(在沉重还有7秒时用疾跑)。" } },
                // PotD 171-180
                ...
                { 5451, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = true, IsUndead = false}, MobNotes="战斗中30s后有狂暴" } },
                { 5452, new MobData { Threat=MobData.ThreatLevel.Easy, Aggro=MobData.AggroType.Proximity, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="敌方增伤buff。捶胸，以一个房间大小的范围造成物理AOE和物理易伤。不要在附近有深宫大脚巨猿时去打怪。也永远不要打一个有增伤BUFF的深宫大脚巨猿，否则你会被一击必杀。他的殴打暴击能造成13k的伤害，所以单人时强烈建议使用魔陶器 强化防御，否则一个连击你就死了。" } },
                { 5453, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true, CanBind = false, CanHeavy = true, CanSleep = true, IsUndead = false}, MobNotes="怒视和百吨回转。怒视是一个几乎瞬发的正面直线AOE。百吨回转则是一个圆形AOE(所以走出这个范围就行)这些都是可以被眩晕打断的。" } },
                { 5454, new MobData { Threat=MobData.ThreatLevel.Caution, Aggro=MobData.AggroType.Proximity, Vuln = new MobData.Vulnerabilities{CanStun = true, CanBind = false, CanHeavy = true, CanSleep = true, IsUndead = false}, MobNotes="增强自己的伤害并在非战斗中造成 AoE 伤害的物理" } },
                ...
                { 5459, new MobData { Threat=MobData.ThreatLevel.Vicious, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true, CanBind = false, CanHeavy = false, CanSleep = false, IsUndead = false}, MobNotes="顺劈造成流血，以玩家为目标并造成大量伤害、Vuln Down 和眩晕" } },
                { 5460, new MobData { Threat=MobData.ThreatLevel.Dangerous, Aggro=MobData.AggroType.Sight, Vuln = new MobData.Vulnerabilities{CanStun = true, CanBind = true, CanHeavy = true, CanSleep = true, IsUndead = false}, MobNotes="劈砍造成大量伤害并造成强力流血" } },
                { 5461, new MobData { Threat=MobData.ThreatLevel.Dangerous, Aggro=MobData.AggroType.Boss, Vuln = new MobData.Vulnerabilities{CanStun = false, CanBind = false, CanHeavy = false, CanSleep = false, CanSlow = false, IsUndead = false}, MobNotes="霹雳（前方小扇形aoe）→两连大漩涡→霹雳（扇形aoe）→呵斥(南)→两连大漩涡→霹雳（扇形aoe）→大漩涡→呵斥(北)，循环。15%血黄道陨石，20-18%叠易伤，读条呵斥开始爆发" } },
                // PotD 181-190
